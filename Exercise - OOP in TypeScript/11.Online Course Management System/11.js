...
var ProgrammingCourse = /** @class */ (function (_super) {
    ...
    ProgrammingCourse.prototype.getDescription = function () {
        return "Programming Course: ".concat(this.title, " in ").concat(this.language, " - ").concat(this.duration, " hours");
    };
...
var DesignCourse = /** @class */ (function (_super) {
    ...
    DesignCourse.prototype.getDescription = function () {
        return "Design Course: ".concat(this.title, " using ").concat(this.tools.join(", "), " - ").concat(this.duration, " hours");
    };
    return DesignCourse;
}(Course));
// Тест:
