...
var PlannedHoliday = /** @class */ (function () {
    ...
    PlannedHoliday.prototype.getInfo = function () {
        return "Holiday: ".concat(this._start.getDate(), "/").concat(this._start.getMonth() + 1, "/").concat(this._start.getFullYear(), " - ").concat(this._end.getDate(), "/").concat(this._end.getMonth() + 1, "/").concat(this._end.getFullYear());
    };
...
var HolidayManager = /** @class */ (function () {
    ...
    HolidayManager.prototype.listReservations = function () {
        var result = [];
        Array.from(this.holidays.entries()).forEach(function (entry) {
            result.push("".concat(entry[0].getInfo(), " => ").concat(entry[1]));
        });
        return result.join('\n');
    };
